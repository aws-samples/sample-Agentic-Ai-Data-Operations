"""Silver transformation: type-cast, validate, latest-wins dedup for daily pricing.
...
df = (
    df.withColumn("price_date", F.to_date("price_date", "yyyy-MM-dd"))
      .withColumn("close_price", F.col("close_price").cast(DoubleType()))
...
window = Window.partitionBy("entity_id", "price_date") \
