...
def parse_principal(principal_input: str) -> Tuple[str, str]:
    ...
    Examples:
        "demo-role/hcherian-Isengard" → ("arn:aws:iam::ACCOUNT:role/demo-role", "hcherian-Isengard")
...
def main():
    ...
    parser.add_argument(
        '--principal',
        required=True,
        help='Principal to grant access to (e.g., "demo-role/hcherian-Isengard" or full ARN)'
    )
    parser.add_argument(
        '--skip-iam',
        action='store_true',
