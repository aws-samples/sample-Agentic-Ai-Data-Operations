...
**Grant access to `demo-role/hcherian-Isengard`:**
...
python3 grant_access_to_principal.py --principal demo-role/hcherian-Isengard

# Grant access using full ARN
python3 grant_access_to_principal.py --principal arn:aws:iam::123456789012:role/MyRole

# Skip specific steps
python3 grant_access_to_principal.py --principal demo-role/hcherian-Isengard --skip-qs
```
...
Convenience wrapper for granting access to the specific principal `demo-role/hcherian-Isengard`.
