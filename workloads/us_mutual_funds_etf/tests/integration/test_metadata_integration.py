...
Tests validate that semantic.yaml can be parsed by AWS Semantic Layer consumer,
...
# AWS Semantic Layer consumer parsing tests
class TestAnalysisAgentCompatibility:
    """Tests that validate semantic.yaml can be parsed by AWS Semantic Layer consumer."""
    ...
    def test_has_all_required_sections_for_nlp(self, semantic_config: Dict[str, Any]):
        ...
        for section in required_sections:
            assert section in semantic_config, f"Missing section for AWS Semantic Layer consumer: {section}"
        ...
        for zone in ["silver", "gold"]:
            for table_name, table_def in semantic_config["tables"][zone].items():
                ...
                for col_name, col_def in columns.items():
                    # Required fields for AWS Semantic Layer consumer
...
class TestJoinSemantics:
    ...
    def test_join_provides_analysis_guidance(self, semantic_config: Dict[str, Any]):
        """Test join semantics provide guidance for AWS Semantic Layer consumer."""
        joins = semantic_config["business_context"]["join_semantics"]
...
class TestMetadataCompleteness:
    """Tests that validate metadata is complete enough for full AWS Semantic Layer consumer usage."""
