# Access Grant Summary — demo-role/hcherian-Isengard
...
Created comprehensive access grant scripts to provision permissions for `demo-role/hcherian-Isengard` across all components of the US Mutual Funds & ETF workload.
...
**Usage:**
```bash
python3 scripts/access/grant_access_to_principal.py --principal demo-role/hcherian-Isengard
```
...
**Principal ARN:**
```
arn:aws:quicksight:us-east-1:ACCOUNT:user/default/demo-role/hcherian-Isengard
```
...
Once access is granted, `demo-role/hcherian-Isengard` can:
...
aws quicksight update-dashboard-permissions \
  --aws-account-id ACCOUNT \
  --dashboard-id finsights-finance-dashboard \
  --revoke-permissions Principal=arn:aws:quicksight:us-east-1:ACCOUNT:user/default/demo-role/hcherian-Isengard
```
