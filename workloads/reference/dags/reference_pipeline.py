"""Reference Classifications Pipeline DAG (manual trigger)."""
...
with DAG(
    ...
    description="Manual ETL: Bronze -> Silver for entity classifications",
    schedule=None,
    ...
    tags=[WORKLOAD, "classifications", "manual"],
    doc_md=__doc__,
) as dag:
    ...
    wait_for_source = S3KeySensor(
        ...
        bucket_key=f"raw/reference/classifications/*.csv",
        poke_interval=300,
        timeout=3600,
        mode="poke",
    )
    ...
    with TaskGroup("bronze") as bronze_group:
        ingest = GlueJobOperator(
            ...
            script_args={
                ...
                "--source_prefix": "raw/reference/classifications/",
