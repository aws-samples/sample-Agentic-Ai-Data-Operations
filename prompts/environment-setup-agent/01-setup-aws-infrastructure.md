...
CLI:    python3 scripts/setup_avp.py
...
04-enrich-link-datasets     ← add FK relationships between datasets
    ▼
05-govern-trace-lineage     ← compliance docs, impact analysis

Optional/On-Demand:
  - examples/generate-synthetic-data  ← create demo/test data
  - data-analysis-agent/create-dashboard ← QuickSight on Gold data

Troubleshooting (use anytime):
  - troubleshooting/01-fix-iceberg-glue       ← fix Glue/Iceberg issues
  - troubleshooting/02-deep-agent-logging     ← enable detailed tracing
```
