...
1. shared/logging/agent_tracer.py
   ...
   - Output: append to trace_events.jsonl (one JSON object per line)
...
2. shared/logging/trace_viewer.py
   - CLI tool for reading trace_events.jsonl
   - Commands:
   ...
   - Input: path to trace_events.jsonl or directory containing one
