...
Output:
- Generator script: demo/sample_data/data_generator.py (with --seed for reproducibility)
- CSV files: demo/sample_data/[dataset].csv
...
- Generator script at `demo/sample_data/[dataset]_generator.py`
- CSV file at `demo/sample_data/[dataset].csv`
